(function(){
  ...
  (function(){
    ...
    // llenar filtro de sectores
    if(sectorSel){
      var sectores=Array.prototype.slice.call(new Set(data.map(function(d){return d.sector;}))).filter(Boolean).sort();
      sectores.forEach(function(s){var o=document.createElement('option');o.value=s;o.textContent=s;sectorSel.appendChild(o);});
    }
    function current(){
